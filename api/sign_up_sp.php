...
try {
	...
	switch ($_REQUEST['Service'])
	{
		...
		break;
		case "sign_up_social":
			if(isset($_REQUEST['user_name']) && isset($_REQUEST['mobile_no']) && isset($_REQUEST['email']) && isset($_REQUEST['device_id']) && isset($_REQUEST['device_type']) )
			{
				$user_name = $_REQUEST['user_name'];
				$mobile_no = $_REQUEST['mobile_no'];
				$email = $_REQUEST['email'];
				...
				update_field('field_5b0d1a816d88a', 'approved', 'user_'.$user_id);
